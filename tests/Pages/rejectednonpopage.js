...
exports.nonPoInvoiceRejected =
class nonPoInvoiceRejected {
  ...
  constructor(page) {
    ...
    this.rejected = 'menu-item-reject';
    this.comments1 = 'input-approval-remarks';
  ...
  async nonPoRejected(searchId,comments){
            ...
            await this.page.getByTestId(this.comments1).click();
            await this.page.getByTestId(this.comments1).fill(comments);
