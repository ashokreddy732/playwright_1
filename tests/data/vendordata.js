...
exports.SignInVendorData = {

    validUser: {
        email:    'Malinda_Jaskolski@hotmail.com',
        password: 'Test@123',
    },
    ...
    companydetails: {
        ...
        // faker date - past date for incorporation
        IncorporationDate:      faker.date.past({ years: 10 })
                                    .toISOString().split('T')[0],

        LicenseNumber:          'LIC123456',

        // faker date - future date for license expiry
   ...
   contactdetails: [
    {
        //  Contact 1 — Sales Services — Primary
    ...
    certifications: {
        ...
        // faker date - future date for doc expiry
